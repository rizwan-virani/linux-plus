/* ============================================================================
   linux+  ::  flashEngine.js  —  Rapid Recall Flashcards
   ...
   - Cards live in lazy-loaded per-domain modules (assets/js/content/flashN.js),
     each populating LINUXPLUS.flash[N] with 100 cards { id, d, t, obj, front, back }.
   - Scheduling state persists to localStorage (linuxplus.flash.v1) keyed by card id,
...
(function () {
  ...
  function ver() { return window.LINUXPLUS_VER ? "?v=" + window.LINUXPLUS_VER : ""; }
