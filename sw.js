...
var CACHE = "examsite-linuxplus-v1"; /* per-site name: all sites share one origin on GitHub Pages */
var SCOPE = "examsite-linuxplus-"; /* only prune THIS site's old caches */
